...
{
private:
	string _ProgrammingLang;

public:
	clsProgrammer(int ID, string FirstName, string LastName, string Email, string Phone, string Title, string Department, double Salary, string ProgrammingLang) : clsEmployee(ID, FirstName, LastName, Email, Phone,Title, Department, Salary)
	{
		_ProgrammingLang = ProgrammingLang;
	}
	...
	void Print()
	{
		...
		cout << "\nSalary     : " << GetSalary();
		cout << "\nP Language : " << _ProgrammingLang << endl;
		cout << "------------------------";
	}
};
...
int main()
{
	clsProgrammer Programmer1(10, "Mohammed", "Ali", "moh.ali@mail.com", "07802335436", "Developer", "Developing Team", 5000, "C++");
